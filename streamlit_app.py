...
UUID = os.environ.get("UUID", "269c4a00-7fd7-437f-89b6-5a54f47c0ee5")  # UUID
NEZHA_SERVER = os.environ.get("NEZHA_SERVER", "ip.ip.now.cc:8008")  # 哪吒面板域名
NEZHA_PORT = os.environ.get("NEZHA_PORT", "")  # 哪吒端口
NEZHA_KEY = os.environ.get("NEZHA_KEY", "yKJk01vbNgtSeLXlK7L2trLjMmCDKnU6")  # 哪吒密钥
ARGO_DOMAIN = os.environ.get("ARGO_DOMAIN", "streamlit.ip.now.cc")  # Argo固定域名
ARGO_AUTH = os.environ.get("ARGO_AUTH", "eyJhIjoiMGUzZGQ0NGY2MmNhNWQ2ZGE4ZGU1NWQxMTExODk1MTQiLCJ0IjoiMmNmMzVkMjUtNzIxMC00MjQwLWFmNjEtNDMxYzY4MzMxNjFiIiwicyI6IlpqUmxOemRoT0RJdE16ZzNZaTAwWXpnd0xUaGlNR1l0WkdReE5tTTBPVFZsWWpnNSJ9")  # Argo密钥
